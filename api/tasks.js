...
export default async function(req,res){
 ...
 if(a==='save_planner'){const p=req.body?.planner;if(!p||typeof p!=='object'||Array.isArray(p)||JSON.stringify(p).length>25000)return res.status(400).json({error:'invalid_planner'});data.planner=p}
